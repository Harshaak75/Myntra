...
export const Footermobile = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full bg-white border-t-[0.04rem] flex justify-around items-center py-2 text-sm z-20 lg:hidden ">
      <div className="flex flex-col items-center text-pink-600" onClick={() => navigate("/")}>
      ...
      <div className="flex flex-col items-center text-gray-600" onClick={() => navigate("/user/Order")}>
