...
export const generateTokens = async (user_id: any) => {
  console.log(user_id)
  const accessToken = jwt.sign({ id: user_id, currRole:"user",role: "authenticated" , aud: "authenticated" }, serect || "", {
      ...
      try {
        ...
        if (decoded && decoded.exp) {
          ...
          if (timeRemaining > refresh_token_renew_time) {
            ...
            const refreshToken = jwt.sign({ id: user_id, currRole:"user",role: "authenticated" , aud: "authenticated" }, serect || "", {
